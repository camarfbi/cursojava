...
public class Main {
	...
	public static void main(String[] args) {
		...
		while ((nota1 = sc.nextDouble()) < 0 || nota1 > 10) {
			System.out.println("nota invalida");
		}
		while ((nota2 = sc.nextDouble()) < 0 || nota2 > 10) {
			System.out.println("nota invalida");
		}
		media = (nota1 + nota2) / 2;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		int iV = 0, gV = 0, G = 0, I = 0, E = 0, R = 1, Q = 0;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		int N = sc.nextInt();
		int pum = 0, pum2 = 0, pum3 = 0;
	
		for(int i = 0; i < N; i++) {
				pum += 1;
				pum2 = pum + 1;
				pum3 = pum2 + 1;
				System.out.println(pum  + " " + pum2 + " " + pum3 + " PUM");
				pum = pum3 + 1;
			}
		sc.close();
	}
...
public class Main {
	...
	public static void main(String[] args) {
		...
		float idade = 0, media = 0, soma = 0, count = 0;
 ...
 * Locale.setDefault(Locale.US);
 * 
 * int n =sc.nextInt(); int fat = 1;
 * 
 * for(int i = 1; i <= n; i++ ) { fat = i * fat; } System.out.println(fat);
 * sc.close(); } }
 *
 * URI 1157
 *
 ...
 * 
 * for (int i = n; i >= 1; i--) { if (n % i == 0) { res = n / i;
 ...
 * for (int i = 1; i <= n; i++) {
 * 
 * System.out.println(i + " " + i * i + " " + i * i * i); } sc.close(); } }
 *
 * URI
 */
